...
class NextcloudIntegrationTest {
    ...
    fun `discover principal URL from Nextcloud`() = runTest {
    ...
    fun `create basic event on Nextcloud`() = runTest {
    ...
    fun `create event with generated VTIMEZONE New York`() = runTest {
    ...
    fun `create event with generated VTIMEZONE London`() = runTest {
    ...
    fun `create event with generated VTIMEZONE Sydney`() = runTest {
    ...
    fun `create event with generated VTIMEZONE Kolkata`() = runTest {
    ...
    fun `create event without VTIMEZONE when disabled`() = runTest {
    ...
    fun `DefaultQuirks works with real Nextcloud responses`() = runTest {
        assertNotNull(principalUrl)
        assertNotNull(calendarHomeUrl)
        assertNotNull(defaultCalendarUrl)
